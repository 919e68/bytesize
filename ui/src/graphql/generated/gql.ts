...
const documents: Documents = {
    ...
    "\n  mutation CreateRating($attributes: RatingAttributes!) {\n    rating: createRating(attributes: $attributes) {\n      id\n      rate\n\n      snack {\n        id\n      }\n    }\n  }\n": types.CreateRatingDocument,
    "\n  mutation CreateSnack($attributes: SnackAttributes!) {\n    snack: createSnack(attributes: $attributes) {\n      id\n      name\n      icon\n      description\n      createdAt\n      updatedAt\n\n      snackFlavors {\n        id\n        flavor {\n          id\n          name\n          icon\n        }\n      }\n    }\n  }\n": types.CreateSnackDocument,
    "\n  mutation RemoveSnack($id: ID!) {\n    snack: removeSnack(id: $id) {\n      id\n      name\n      icon\n      description\n      createdAt\n      updatedAt\n    }\n  }\n": types.RemoveSnackDocument,
    "\n  mutation UpdateSnack($id: ID!, $attributes: SnackAttributes!) {\n    snack: updateSnack(id: $id, attributes: $attributes) {\n      id\n      name\n      icon\n      description\n      createdAt\n      updatedAt\n\n      snackFlavors {\n        id\n        flavor {\n          id\n          name\n          icon\n        }\n      }\n    }\n  }\n": types.UpdateSnackDocument,
    "\n  query FetchCurrentUser {\n    user: fetchCurrentUser {\n      id\n      username\n      name\n    }\n  }\n": types.FetchCurrentUserDocument,
    "\n  query FetchFlavors($filters: [FilterInput!], $order: [OrderInput!], $page: Int, $limit: Int) {\n    flavors: fetchFlavors(filters: $filters, order: $order, page: $page, limit: $limit) {\n      pagination {\n        page\n        pages\n        limit\n        count\n        prev\n        next\n      }\n\n      nodes {\n        id\n        icon\n        name\n        description\n        createdAt\n        updatedAt\n      }\n    }\n  }\n": types.FetchFlavorsDocument,
    "\n  query FetchFeaturedSnack($featureType: String!) {\n    featuredSnack: fetchFeaturedSnack(featureType: $featureType) {\n      featureType\n      snack {\n        id\n        icon\n        name\n        description\n        snackFlavors {\n          id\n          flavor {\n            id\n            name\n            icon\n          }\n        }\n\n        flavorMatchScore\n        averageRating\n        ratingCount\n        currentUserRating\n\n        createdAt\n        updatedAt\n      }\n    }\n  }\n": types.FetchFeaturedSnackDocument,
    "\n  query FetchSnack($id: ID!) {\n    snack: fetchSnack(id: $id) {\n      id\n      icon\n      name\n      description\n      snackFlavors {\n        id\n        flavor {\n          id\n          name\n          icon\n        }\n      }\n\n      flavorMatchScore\n      averageRating\n      ratingCount\n      currentUserRating\n\n      createdAt\n      updatedAt\n    }\n  }\n": types.FetchSnackDocument,
