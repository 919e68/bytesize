...
function Table({ className, ...props }: React.ComponentProps<'table'>) {
  return (
    <div className="scrollbar-thin relative w-full flex-1 overflow-x-auto" data-slot="table-container">
      <table className={cn('w-full table-auto caption-bottom text-sm', className)} data-slot="table" {...props} />
    </div>
  )
}
